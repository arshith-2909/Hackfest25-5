...
import {
  CircularProgressbar,
  buildStyles,
} from "react-circular-progressbar"; // For circular progress visualization
import "react-circular-progressbar/dist/styles.css";

// Feature data for the dashboard boxes
const features = [
  {
    title: "Booking",
    ...
    <section className="bg-[#1A1D23] py-16 px-6">
      ...
      <div className="fixed top-6 right-6 flex items-center space-x-4 z-10">
        <div className="relative">
          ...
          {/* Profile Dropdown */}
          <div className="absolute right-0 mt-2 bg-gray-800 text-white rounded-md shadow-lg w-48 opacity-0 group-hover:opacity-100 transition-opacity group">
            <ul className="py-2">
              <li
      ...
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-5xl font-bold text-[#34C759] mb-6">Interactive Financial Dashboard</h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          ...
          <div className="bg-[#2F3436] rounded-xl p-6 shadow-lg flex flex-col items-center justify-center">
            <h3 className="text-lg font-semibold text-white mb-4">Transaction Detail</h3>
            <div className="h-40 w-full flex items-center justify-center text-gray-600">
